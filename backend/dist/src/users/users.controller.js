...
__decorate([
    (0, common_1.Get)('me/resources'),
    (0, swagger_1.ApiOperation)({ summary: 'Recursos enviados pelo usuário logado' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], UsersController.prototype, "myResources", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Perfil público de um usuário' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: '[Admin] Listar todos os usuários' }),
...
__decorate([
    ...
    (0, common_1.UseGuards)(roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(client_1.Role.ADMIN),
    (0, swagger_1.ApiOperation)({ summary: '[Admin] Ativar/desativar usuário' }),
    __param(0, (0, common_1.Param)('id')),
